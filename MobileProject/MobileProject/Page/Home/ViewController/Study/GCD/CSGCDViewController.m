//
//  CSGCDViewController.m
//  MobileProject
//
//  Created by capaipai@sina.com on 2018/12/18.
//  Copyright © 2018年 capaipai. All rights reserved.
//

#import "CSGCDViewController.h"

@interface CSGCDViewController ()

@end

@implementation CSGCDViewController
...
- (void)asyncConcurrent {
    ...
    dispatch_queue_t queue = dispatch_queue_create("asyncConcurrentQueue", DISPATCH_QUEUE_CONCURRENT);
...
- (void)syncSerial {
    ...
    dispatch_queue_t queue = dispatch_queue_create("syncSerialQueue", DISPATCH_QUEUE_SERIAL);
...
- (void)asyncSerial {
    ...
    dispatch_queue_t queue = dispatch_queue_create("asyncSerialQueue", DISPATCH_QUEUE_SERIAL);
...
{
    return [self changeTitle:@"GCD 学习探究"];
}
