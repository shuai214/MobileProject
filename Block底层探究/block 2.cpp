...
__OBJC_RW_DLLIMPORT void objc_msgSend(void); // 消息转发
...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  int a = __cself->a; // bound by copy copy为值拷贝 s只是把值拿来用.但是对象的内存空间没有被拿过来,就不能修改该对象.
...
int a = 10;
void (*block)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, a)); //声明一个对象 传入一个参数 a
