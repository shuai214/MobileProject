...
#define CHINESE_FON_Regular @"PingFangSC-Regular"
#define CHINESE_FON_Medium @"PingFangSC-Medium"
#define CHINESE_FON_Semibold @"PingFangSC-Semibold"
#define CHINESE_FON_Light @"PingFangSC-Light"

#define CHINESE_SYSTEM_R(x) [UIFont fontWithName:CHINESE_FON_Regular size:x]
#define CHINESE_SYSTEM_M(x) [UIFont fontWithName:CHINESE_FON_Medium size:x]
#define CHINESE_SYSTEM_S(x) [UIFont fontWithName:CHINESE_FON_Semibold size:x]
#define CHINESE_SYSTEM_L(x) [UIFont fontWithName:CHINESE_FON_Light size:x]
...
#define FontSize_R(R)     CHINESE_SYSTEM_R(AdaptedWidth(R))
#define FontSize_M(R)     CHINESE_SYSTEM_M(AdaptedWidth(R))
#define FontSize_S(R)     CHINESE_SYSTEM_S(AdaptedWidth(R))
#define FontSize_L(R)     CHINESE_SYSTEM_L(AdaptedWidth(R))
...
#define DEVICE_ID [CMUUIDManager readUUID]

//获取本地的文案
#define LOCAL_STRING(OBJECT) NSLocalizedString(OBJECT,nil)

//色值
#define RGBA(r,g,b,a) [UIColor colorWithRed:r/255.0f green:g/255.0f blue:b/255.0f alpha:a]
#define RGB(r,g,b) RGBA(r,g,b,1.0f)
//全局背景色
#define CSRGBCOLOR RGB(245,245,245)

#define HEXCOLOR(hex) [UIColor colorWithHexString:hex withAlpha:1]
...
//#define SESSION_ID [PlistFile ReadNSuserDefault:@"sessionId"]
//#define USER_ID [PlistFile ReadNSuserDefault:@"userId"]
//#define USER_IMAGE [PlistFile ReadNSuserDefault:@"avatar"]
