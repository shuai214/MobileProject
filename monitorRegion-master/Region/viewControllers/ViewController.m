...
- (void)initMap {
    ...
    for (StudentInfoModel *student in [RegionManager shareInstance].studentArray) {
        ...
        MKCircle *circle =[MKCircle circleWithCenterCoordinate:student.location radius:kRegionRadius * 1];
         MKCircle *circle1 =[MKCircle circleWithCenterCoordinate:student.location radius:kRegionRadius * 2];
         MKCircle *circle2 =[MKCircle circleWithCenterCoordinate:student.location radius:kRegionRadius * 3];
        //先添加，在回调方法中创建覆盖物
